...
describe("fetchSignUp", () => {
  ...
  it("throws an error if response.ok is false", async () => {
    ...
    const expected = Error(`Network request failed. (error: 500)`);
    await expect(fetchSignUp()).rejects.toEqual(expected);
  });
...
describe("fetchDeletePet", () => {
  ...
  it("throws an error if response.ok is false", async () => {
    ...
    const expected = Error(`Network request failed. (error: 500)`);
    await expect(fetchDeletePet()).rejects.toEqual(expected);
  });
...
describe("fetchLikePostPet", () => {
  ...
  it("should delete a pet with correct params", async () => {
    await fetchLikePostPet(user_id, id);
  ...
  it("should return the correct data", async () => {
    ...
    const result = await fetchLikePostPet(user_id, id);
  ...
  it("throws an error if response.ok is false", async () => {
    ...
    const expected = Error(`Network request failed. (error: 500)`);
    await expect(fetchLikePostPet()).rejects.toEqual(expected);
  });
