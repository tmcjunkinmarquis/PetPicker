...
export class IndividualMatch extends Component {
  ...
  render() {
    return (
      ...
      {this.props.match.owner ? <a onClick={this.makeMatch} className="title left pet-title">{this.props.match.name}</a> : <span className="title left pet-title">{this.props.match.name}</span>}
      <br />
